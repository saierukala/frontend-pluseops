...
export default function RegisterPage() {
  ...
  const { register: registerUser, error: authError, isLoading, clearError } = useAuth();
  ...
  return (
    <AuthLayout>
      <AuthCard
        ...
        description="Enter your details to get started. Tenant workspaces are created by platform administrators."
        footer={

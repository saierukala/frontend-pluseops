...
// shadcn Dialog primitives — used by all PulseOps dialogs
...
// PulseOps compat: existing F02 Dialog API (confirm/cancel) — now backed by shadcn Radix Dialog
...
export function Dialog({
  ...
  return (
    <DialogRoot open={open} onOpenChange={onOpenChange}>
      <DialogContent className={cn("max-w-md", className)} showCloseButton={!loading}>
        <DialogHeader>
